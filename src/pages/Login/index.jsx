...
import { Container, Wrapper, Column, Row,  Title, TitleLogin, SubtitleLogin, CriarText, EsqueciText } from './styles';
...
const Login = () => {
    ...
    const { control, hendleSubmit, formState: { errors, isValid } } = useForm({
